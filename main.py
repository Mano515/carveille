        ...
        def do_POST(self):
            ...
            if self.path == "/clients":
                ...
                data = {
                    ...
                    "finition": body.get("finition") or None,
                    "finition_imperatif": int(bool(body.get("finition_imperatif", False))),
                    "notifications_actives": int(bool(body.get("notifications_actives", False))),
                    ...
                    "prix_min": body.get("prix_min") or None,
                    "boite": body.get("boite", "indifferent"),
                    "carburant": body.get("carburant", "indifferent"),
                    "couleur": body.get("couleur") or None,
                    "couleur_imperatif": int(bool(body.get("couleur_imperatif", False))),
                    "vendeur_filtre": body.get("vendeur_filtre", "indifferent"),
                    "options_recherchees": body.get("options_recherchees", ""),
                    "options_imperatives": body.get("options_imperatives") or None,
                    "carrosserie": body.get("carrosserie") or None,
                    "materiaux_interieur": body.get("materiaux_interieur") or None,
                    "couleur_interieure": body.get("couleur_interieure") or None,
